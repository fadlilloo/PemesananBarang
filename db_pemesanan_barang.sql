...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 04 Sep 2026 pada 06.00
...
INSERT INTO `barang` (`id_barang`, `nama_barang`, `harga`, `stok`, `keterangan`) VALUES
(1, 'Laptop ASUS', 7000000.00, 10, 'Laptop untuk kebutuhan sekolah dan kerja'),
(2, 'Mouse Logitech', 150000.00, 20, 'Mouse wireless'),
(3, 'Keyboard Gaming', 350000.00, 15, 'Keyboard gaming RGB'),
(4, 'Headset', 250000.00, 10, 'Headset gaming'),
(5, 'Camera', 500.00, 25, 'Camera Untuk Live');
...
(2, 'fadli', '1', 'Fadli Ibrahim', 'pembeli');
